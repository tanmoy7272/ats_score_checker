    ...
    <div className="bg-white rounded-2xl p-8 shadow-md border border-slate-200">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-slate-600 text-sm">Based on 10 key parameters</p>
        </div>
        <div className="flex items-center gap-12">
          ...
          <div className="text-right">
            <div className="text-3xl font-bold text-slate-900">{matchedCount}<span className="text-xl text-slate-500">/10</span></div>
